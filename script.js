...
const fileSystem = {
    ...
    'projects': {
        ...
        'zig-spikes': "Experiments and learning projects in Zig.\nLink: https://github.com/sku0x20/ZIG-SPIKES",
        ...
        'aws-workshop': "AWS Workshop resources and code.\nLink: https://github.com/sku0x20/AWS-WORKSHOP",
        'terraform-configs': "Infrastructure as Code using Terraform.\nLink: https://github.com/sku0x20/TERRAFORM-CONFIGS",
        'no-libc': "Experiments without standard C library.\nLink: https://github.com/sku0x20/NO-LIBC",
        'observability-configs': "Configuration for Prometheus, Grafana, Loki etc.\nLink: https://github.com/sku0x20/OBSERVABILITY-CONFIGS",
        'replicate': "Project Replicate.\nLink: https://github.com/sku0x20/REPLICATE",
        'quarkus': "Quarkus framework experiments.\nLink: https://github.com/sku0x20/QUARKUS",
        'grunner': "Grunner task runner project.\nLink: https://github.com/sku0x20/GRUNNER",
        'learning-gradle': "Gradle build tool learning resources.\nLink: https://github.com/sku0x20/LEARNING-GRADLE",
        'flutter-spikes': "Flutter state management experiments.\nLink: https://github.com/sku0x20/FLUTTER_SPIKE_STATE_MANAGEMENT",
        'openssl-ca': "OpenSSL Certificate Authority scripts.\nLink: https://github.com/sku0x20/OPENSSL-CA",
        'go-spikes': "Go language experiments and spikes.\nLink: https://github.com/sku0x20/GO-SPIKES",
        'sudoku': "Sudoku solver/game.\nLink: https://github.com/sku0x20/SUDOKU",
        'butterflys-adventure': "A game or story project.\nLink: https://github.com/sku0x20/BUTTERFLYS-ADVENTURE",
        'request-generator': "HTTP request generation tool.\nLink: https://github.com/sku0x20/REQUEST-GENERATOR",
        'dart-intro': "Introduction to Dart programming language.\nLink: https://github.com/sku0x20/DART-INTRO",
        'grpc-protocol-buffers': "gRPC and Protocol Buffers examples.\nLink: https://github.com/sku0x20/GRPC-PROTOCOL_BUFFERS",
        'simple-spring-hal-rest': "Spring Boot HAL REST API example.\nLink: https://github.com/sku0x20/SIMPLE-SPRING-HAL-REST"
    },
