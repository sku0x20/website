...
Apart from how it looks, I usually don't care — it's mostly a one-time thing, so I avoid breaking my head over it. But once it's something that has to be maintained, I take control. I'm pretty averse to AI tools generally, but as you can see, I'm not letting it run loose: I review every single line, understand it, and if I can't understand it, I ask Claude to make it readable. If it still can't, I sometimes do it by hand and ask it to replicate the change elsewhere.

I'm taking lessons, observing the APIs. If it's not coming out good, let's go back and try something else. And it's very cheap now — I can think more freely, more actively, while Claude is dumping characters, printing to the screen. I can see what's looking odd. I can actively think through the other path, the what-ifs. In my opinion, AI hasn't just accelerated code output, but thinking and adapting too.
