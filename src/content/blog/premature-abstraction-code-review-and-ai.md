...
I'm always someone who keeps things simple and minimal — be it code, be it indirection, be it even the AI agent itself. I'm using Claude and haven't switched, not even once. It's working well enough for me — I never need to look elsewhere. And I'm using Sonnet. I did ask it to take advice from Opus, and Opus does catch issues that even I missed...
